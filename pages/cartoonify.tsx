...
export default function cartoonify() {
  ...
  async function generateCartoon(fileUrl: string) {
    ...
    if (res.status !== 200) {
      ...
      toast("Clear Photo is generated successfully");
  ...
  return (
    <div className="w-full h-screen">
      ...
      <main className="max-w-6xl mx-auto  pt-6 ">
        <ToastContainer />
        <h1 className="text-4xl font-bold text-center">Restore any photo</h1>
        ...
        {!originalPhoto && (
          <div className="flex items-center gap-4 pt-6 justify-center">
            <img
              src={"/images/catnotrefine.jpg"}
              alt="in images"
              className="rounded-full object-cover w-[220px]"
            />
            <img
              src={"/images/catrefine.png"}
              alt="in images"
